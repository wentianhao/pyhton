...
# print(flight_data)
flight_data_head = flight_data.head()
# print(flight_data_head)
flight_data_shape = flight_data.shape
# print(flight_data_shape)   # (144, 3) 包含12年的乘客旅行记录

'''
任务根据前132个月来预测最近12个月内旅行的乘客人数。
有144个月的记录，前132个月的数据将用于训练我们的LSTM模型，
而模型性能将使用最近12个月的值进行评估。
'''
# print(flight_data['passengers'])
# 绘制每月乘客人数的频率
...
# plt.savefig('MonthvsPassenger.png')
# plt.show()

col = flight_data.columns
# print(col)

# 将passengers列的类型改为float
...
# plt.savefig('MonthvsPassenger1.png')
...
plt.plot(x,actual_predictions)
# plt.show()
plt.savefig('MonthvsPassenger2.png')